    ...
    <>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">About Bitvalley</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            At Bitvalley, we are passionate about transforming ideas into impactful digital experiences. 
      ...
      <CTASection
        ...
        description="Let's discuss how Bitvalley can help you achieve your digital goals."
